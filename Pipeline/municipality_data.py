"""
Raw municipality data for D_LOCATION.

Municipality names and districts sourced from the official
administrative division of Portugal (18 districts + Azores + Madeira),
cross-checked against Wikipedia's "List of municipalities of Portugal"
during this session. Per-district and total counts were verified to
sum to 308.

This file holds only the source data. Region derivation, the Setubal
NUTS II split, code generation and loading logic live in
populate_d_location.py, which imports this module.
"""
...
DISTRICT_MUNICIPALITIES = {
    ...
    "Beja": [
        ...
        "Moura", "Odemira", "Ourique", "Serpa", "Vidigueira",
    ],
    "Braga": [
    ...
    "Leiria": [
        ...
        "Caldas da Rainha", "Castanheira de Pera", "Figueiró dos Vinhos",
    ...
    "Viseu": [
        "Armamar", "Carregal do Sal", "Castro Daire", "Cinfães",
        "Lamego", "Mangualde", "Moimenta da Beira", "Mortágua",
        "Nelas", "Oliveira de Frades", "Penalva do Castelo",
        "Penedono", "Resende", "Santa Comba Dão",
        "São João da Pesqueira", "São Pedro do Sul", "Sátão",
        "Sernancelhe", "Tabuaço", "Tarouca", "Tondela",
        "Vila Nova de Paiva", "Viseu", "Vouzela",
    ],
    "Azores": [
        "Angra do Heroísmo", "Calheta", "Corvo", "Horta", "Lagoa",
        "Lajes das Flores", "Lajes do Pico", "Madalena", "Nordeste",
        "Ponta Delgada", "Povoação", "Praia da Vitória",
        "Ribeira Grande", "Santa Cruz da Graciosa",
        "Santa Cruz das Flores", "São Roque do Pico", "Velas",
